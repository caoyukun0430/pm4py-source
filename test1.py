...
sublog2 = xes_importer.apply("/home/yukun/resultlog/log_6_2_dfgRequestedAmount.xes")
...
log = xes_importer.apply("/home/yukun/dataset/BPIC2017.xes")
sublog2 = xes_importer.apply("/home/yukun/resultlog/log_6_3_dfgRequestedAmount.xes")
#log = parquet_importer.import_minimal_log("bpic2017_application.parquet")
print("imported")
net, im, fm = inductive_miner.apply(sublog2)
# net, im, fm = petri_importer.apply("/home/yukun/dataset/sublog2.pnml")
