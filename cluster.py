...
if __name__ == "__main__":
    ...
    list_of_vals = ['25000', '10000', '15000', '30000', '7000']
    num = 10
    freq = 5
    alpha = 0.5
    ...
    for i in range(len(list_of_vals)):
        ...
        varsample = filter_subsets.sublog2varlist(logsample, freq)
    ...
    for i in range(0, size - 1):
        for j in range(i + 1, size):
            ...
            sim_act = sim_calc.dist_calc(lists[i], lists[j], lists[i + size],
                                         lists[j + size],
                                         freq, 0.5, parameters={"single": True})
